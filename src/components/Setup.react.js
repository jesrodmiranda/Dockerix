...
var Setup = React.createClass({
  ...
  renderProgress: function () {
    ...
    let descr = 'To run Docker containers on your computer, Dockerix is starting a Linux virtual machine. This may take a minute...';
    if (util.isNative()) {
      title = 'Checking Docker';
      descr = 'To run Docker containers on your computer, Dockerix is checking the Docker connection.';
    }
    return (
      <div className="setup">
  ...
  renderError: function () {
    ...
    let usualError = (
      <div className="content">
        <h4>Setup Error</h4>
        <h1>We&#39;re Sorry!</h1>
        <p>There seems to have been an unexpected error with Dockerix:</p>
